...
copies. The gold-quality example to match is
...
Table-heavy chapters (combat, spells, monsters, equipment) need the most
coordinate-dump verification; prose chapters (intro, mythos) condense fastest.
